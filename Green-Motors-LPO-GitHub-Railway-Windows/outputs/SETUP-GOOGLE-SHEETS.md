...
10. Open the deployed Railway app, click **Settings**, paste the URL, and save. Settings saved in the local `file://` version do not transfer to the Railway website.
